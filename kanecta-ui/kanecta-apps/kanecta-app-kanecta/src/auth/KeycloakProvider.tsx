...
export interface KeycloakContextValue {
  ...
  // True when VITE_AUTH_DISABLED=true — lets engineers run this app locally
...
// Same pattern as kanecta-app-studio/src/auth/KeycloakProvider.tsx — this app
// shares Studio's auth infrastructure rather than inventing its own.
