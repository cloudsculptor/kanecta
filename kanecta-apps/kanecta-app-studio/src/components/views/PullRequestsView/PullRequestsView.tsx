...
function PrStateIcon({ state }: { state: MockPR['state'] }) {
  if (state === 'merged') {
    return <MergeTypeIcon className={`PRIcon PRIcon--merged`} />;
  }
  if (state === 'closed') {
    return <AltRouteIcon className={`PRIcon PRIcon--closed`} />;
  }
      ...
      <div className="PullRequestsView__detail-body">
        {subTab === 'conversation' && (
          <div className="PullRequestsView__conversation">
            ...
            <div className="PullRequestsView__no-reviews">
              No reviews yet
            </div>
          </div>
        )}
...
function MergeSyncTab() {
  return (
    <div className="PullRequestsView__merge-page">
      <div className="PullRequestsView__empty">
        Merge / Sync — coming soon
      </div>
    </div>
  );
}
