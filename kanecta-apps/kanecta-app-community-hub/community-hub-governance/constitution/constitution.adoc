...
. Has consented to participate in governance activities, including attending general meetings and volunteering; and
...
. Participant Membership requires no additional fee or qualification beyond Voting Membership.
. Any Voting Member may become a Participant Member by notifying the Secretary in writing (including electronically) of their consent to be included in the sortition pool.
. A Participant Member may withdraw their consent at any time by notifying the Secretary, upon which they revert to Voting Member status.
. Only Participant Members are eligible for sortition selection to the Custodian Board (see clause 9.4).
...
. The current maximum annual contribution that confers any additional benefit or influence is **NZ$100 per person or body corporate**.
...
. The Society will not accept any single contribution from any individual, organisation, or funder exceeding NZ$100 per calendar year.
...
. **The Custodian Board** (5 persons) — selected by sortition (random lot) from eligible Participant Members; and
...
. The Custodian Board is selected by random lot (sortition) from the pool of eligible Participant Members.
...
. At least 30 days before the AGM, the Secretary publishes a call for Custodian Board nominations to all members, noting that only Participant Members are eligible.
. Any eligible Participant Member may put their name forward for sortition selection.
...
. **Bootstrap model** (clause 18) — ✅ Confirmed: appointed founding board, one-year sunset, dissolution if threshold not reached.
