# Kanecta Datastore Specification — v1.2.0
...
| [file-specs/meta.json](file-specs/meta.json) | `.kanecta/data/{s1}/{s2}/{uuid}/meta.json` | Denormalized type display cache for typed object items |
