...
| [file-specs/config.json](file-specs/config.json) | JSON Schema for `config.json` — the bootstrap config that tells the platform where datastores live and how to connect to remotes. |
